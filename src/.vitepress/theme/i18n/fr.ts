...
const fr: TranslationSchema = {
    ...
    features: {
        ...
        chart: 'Générer des graphiques SVG (barres, lignes, camembert, donut) à partir de tableaux de données avec couleurs et dimensions personnalisables.',
        ...
        evaluate:
            'Évaluer des expressions mathématiques en toute sécurité avec constantes, fonctions et opérateurs. Sans eval().',
