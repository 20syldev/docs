...
const en: TranslationSchema = {
    ...
    features: {
        ...
        chart: 'Generate SVG charts (bar, line, pie, donut) from data arrays with customizable colors and dimensions.',
        ...
        evaluate: 'Safely evaluate mathematical expressions with constants, functions, and operators. No eval().',
