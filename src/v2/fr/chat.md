...
```bash
curl -X GET "https://api.sylvain.sh/v2/chat"
```
...
```bash
curl -X POST -d "username=Utilisateur3&message=Ça va ?&session=abc123&token=41a43360-9874-4c7a-9ca8-eec29e765a0e" "https://api.sylvain.sh/v2/chat"
```
