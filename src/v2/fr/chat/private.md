...
<Endpoint method="post" path="/v2/chat/private" baseUrl="https://api.sylvain.sh" />
...
```bash
curl -X POST -d "username=Utilisateur3&token=41a43360-9874-4c7a-9ca8-eec29e765a0e" "https://api.sylvain.sh/v2/chat/private"
```
