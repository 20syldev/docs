...
Some endpoints have rate limiting to prevent abuse. If you exceed the [rate limit](/v5/en/pricing), you'll receive an error response:
...
- [v4 Documentation](/v4/en/) - Previous stable version
