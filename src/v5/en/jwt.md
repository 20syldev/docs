...
| `Invalid JWT header: not valid base64url JSON`          | The header part is not valid base64url-encoded JSON  |
| `Invalid JWT payload: not valid base64url JSON`         | The payload part is not valid base64url-encoded JSON |
