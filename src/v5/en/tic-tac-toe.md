...
- <Method type="post" sm /> [/v5/tic-tac-toe/fetch](./tic-tac-toe/fetch) - Retrieve current game information
- <Method type="post" sm /> [/v5/tic-tac-toe/list](./tic-tac-toe/list) - List all public games
- <Method type="patch" sm /> [/v5/tic-tac-toe/:game](./tic-tac-toe/play) - Play a move
- <Method type="delete" sm /> [/v5/tic-tac-toe/:game](./tic-tac-toe/forfeit) - Forfeit a game
