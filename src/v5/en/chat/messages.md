...
- <Method type="post" sm /> [/v5/chat](../chat) - Send a message
- <Method type="post" sm /> [/v5/chat/private](./private) - Create and manage private chat channels
- <Method type="delete" sm /> [/v5/chat/:token](./clear) - Clear all messages from a private chat
