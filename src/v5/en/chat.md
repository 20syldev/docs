...
- <Method type="get" sm /> [/v5/chat](./chat/messages) - Retrieve all recent messages
- <Method type="post" sm /> [/v5/chat/private](./chat/private) - Create and manage private chat channels
- <Method type="delete" sm /> [/v5/chat/:token](./chat/clear) - Clear all messages from a private chat
