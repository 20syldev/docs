...
- <Method type="post" sm /> [/v5/chat](../chat) - Envoyer un message
- <Method type="post" sm /> [/v5/chat/private](./private) - Créer et gérer des canaux de chat privés
- <Method type="delete" sm /> [/v5/chat/:token](./clear) - Effacer les messages d'un chat privé
