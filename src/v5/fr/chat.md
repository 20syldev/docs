...
- <Method type="get" sm /> [/v5/chat](./chat/messages) - Récupérer les messages récents
- <Method type="post" sm /> [/v5/chat/private](./chat/private) - Créer et gérer des canaux de chat privés
- <Method type="delete" sm /> [/v5/chat/:token](./chat/clear) - Effacer les messages d'un chat privé
