...
- <Method type="post" sm /> [/v5/tic-tac-toe/fetch](./tic-tac-toe/fetch) - Récupérer les informations de la partie en cours
- <Method type="post" sm /> [/v5/tic-tac-toe/list](./tic-tac-toe/list) - Lister toutes les parties publiques
- <Method type="patch" sm /> [/v5/tic-tac-toe/:game](./tic-tac-toe/play) - Jouer un coup
- <Method type="delete" sm /> [/v5/tic-tac-toe/:game](./tic-tac-toe/forfeit) - Abandonner une partie
