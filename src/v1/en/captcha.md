...
```bash
curl -X GET "https://api.sylvain.sh/v1/captcha?text=test1234?ABCD" --output captcha.png
```

::: tip Example
[See an example of the generated captcha](https://api.sylvain.sh/v1/captcha?text=test1234?ABCD)
:::
