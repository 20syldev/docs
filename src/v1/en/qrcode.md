...
<HEndpoint method="get" path="/v1/qrcode" baseUrl="https://api.sylvain.pro" />
...
```
GET /v1/qrcode?url=https://docs.sylvain.pro
```
...
```bash
curl -X GET "https://api.sylvain.pro/v1/qrcode?url=https://docs.sylvain.pro"
```
